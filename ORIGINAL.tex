...
\fala{Gianni} Vivemos sob um Estado de exceção em que golpes nascem dentro de
...
\fala{Mino} Antes de o Lula ser condenado em segunda instância, é preciso
...
\fala{G} O golpe institucional para destituir Dilma remonta a agosto de 2016.
O objetivo era tornar o Lula Inelegível.

\fala{M} No meu entendimento é preciso compreender que retirar o Lula desse
...
\fala{G} Lula provavelmente será condenado em segunda instância. O magistrado
...
\fala{M} Não há saída para o País sem um enfrentamento. Um grande abalo
...
\fala{G} Sim, o trabalho escravo encaixa bem com a nossa casa-grande e
...
\fala{M} Não se trata de um retorno porque a casa-grande, assim como a
...
\fala{G} Suponhamos que o povo não reaja e Lula seja inelegível em outubro de
...
\fala{M} O candidato que Lula escolher, o Lula da vez, parte favorito no meu
...
\fala{G} Acha que esses senhores e o povo entendem o significado de um
...
\fala{G} Acha que se o Lula tivesse sido chefe da Casa Civil no início do
segundo mandato de Dilma não teria ocorrido o impeachment?

\fala{M} Certamente não teria ocorrido o impeachment. O Lula, é um mobilizador
...
\fala{G} O mensalão foi o primeiro golpe contra Lula e o PT?

\fala{M} Uma tentativa de golpe, eu diria. Apesar do mensalão o Lula se
...
\fala{G} Como levar a Lava Jato a sério se o Judiciário está politizado?

\fala{M} O Judiciário está bastante politizado a serviço da casa-grande a
...
\fala{G} Como obteve essa informação?

\fala{M} É uma convicção minha. É um sentimento que se abriga no fundo do meu
...
\fala{G} As primeiras perguntas dirigidas às pessoas que se prestam a fazer as
delações premiadas são sobre o Lula. Indaga\fala{M} Sabem algo sobre o Lula?

\fala{M} Querem a pele do Lula. Esse Santo Ofício de Curitiba prestou-se ao
...
\fala{G} Você diz que um \emph{mea culpa} por parte das esquerdas brasileiras
é fundamental. Inclusive para conscientizar o povo.

\fala{M} Quem se disse de esquerda no Brasil nunca chegou realmente ao povo
...
\fala{G} Espanta o fato de os petroleiros não terem agido como outrora na
privatização da Petrobras.

\fala{M} Claro que espanta. Isso aconteceu em outros tempos. Tempos distantes.
...
\fala{G} Você fez a primeira capa de Lula em fevereiro de 1978 na semanal
\emph{IstoÉ}. Naqueles tempos houve greves bem organizadas e eficazes.

\fala{M} O Lula nasceu daquela nova leva de sindicalistas. O PT nasceu ali.
...
greve geral, si\fala{M} parou praticamente tudo, menos os aeroportos. Mas
...
\fala{G} Em recente entrevista com Lula, ele me disse que há vários
``Lulinhas'' para substituí-lo.

\fala{M} Se ficar claro na eleição que o favorito é um petista indicado por
...
\fala{G} Esqueçamos o Dom Pedro I e o suposto grito do Ipiranga, que até hoje
não se sabe se de fato existiu. No entanto, durante a ditadura militar e
das elites, entre 1964 e 1985, morreram 500 pessoas...

\fala{M} 450.

\fala{G} Foram torturadas 1,8 milhão de pessoas. Houve uma esquerda no Brasil.
Existem o Movimento Sem Terra (MST), o Movimento dos Trabalhadores Sem
Teto (MTST)...

\fala{M} De fato, os Sem-Teto e o MST são movimentos reais e souberam
...
\fala{G} E qual é a solução para isso?

\fala{M} Temos razões de sobra para finalmente mostrar a cara. As esquerdas
têm de ir para a rua com o povo. Porque no fundo tudo isso mostra o quê?
Tibieza, falta de coragem, medo.

\fala{G} O PT foi formado em 1980 por um movimento corajoso de esquerda.

\fala{M} De fato, aquelas greves são a meu ver o movimento de resistência mais
...
\fala{G} Preso 31 dias no DOPS (Departamento de Ordem Política e Social;
extinto em 1983).

\fala{M} Lembro da Vila Euclides cheia até as bordas. Foram momentos
extraordinários. Era o povo na rua. O povo reagia.

\fala{G} O PT tem quase 20 por cento do eleitorado. Lula concorda ser maior
...
\fala{M} O Lula tem razão. Mas o PT no poder, confesso, foi uma grande
decepção. Por quê? Acreditou em conciliação com os neoliberais.

\fala{G} Creio que Lula tentou ser pragmático. Quis mostrar às elites que não
era um homem perigoso. E agora ela está mostrando a sua face.

\fala{M} Mas isso foi perda de tempo. Sabe por quê? Porque os ricos e super
...
\fala{G} Houve também a espinhosa aliança do PT com o PMDB.

\fala{M} Mas aí há uma injunção política. É preciso entender que se você
...
\fala{G} Por vezes o Lula se cercou de ministros preciosos como o chanceler
...
\fala{G} Mas ao contrário de seus antecessores, Lula implementou programas
sociais importantes para tirar milhões da miséria.

\fala{M} Claro. Como eu disse, houve avanços sociais importantes. Mas nem por
...
\fala{G} A conscientização do povo e os programas sociais deveriam ter sido um
processo concomitante...

\fala{M} Não há dúvida. Veja o resultado. Sim, houve brasileiros que entraram
...
\fala{G} Mas isso por conta das reformas feitas pelo atual governo ilegítimo
nos últimos 15 meses.

\fala{M} Estamos diante de um desastre. As reformas atingem os trabalhadores.
...
\fala{G} O Lula disse em outubro, durante a pré-campanha dele em Minas Gerais,
...
\fala{M} Lula seria um presidente que inaugura novamente uma estação
...
\fala{G} O balanço dos governos do PT é positivo, o que explica o nível de
...
\fala{M} Houve dados da política econômica do Lula positivos. Por isso digo
...
\fala{G} Este abismo se deve, entre outros, a falta de uma reforma tributária
e de uma reforma agrária.

\fala{M} Nada de realmente profundo foi feito. Taxar os ricos, por exemplo.
Nem passa pela cabeça de qualquer governo brasileiro. Lula taxou? Dilma
taxou? Não.

\fala{G} No entanto, Lula não tinha maioria no Congresso para fazer certas
...
\fala{M} Mas se o pais é democrático você terá inevitavelmente uma mídia a
...
\fala{G} Uma empresa não pode ter um número X de plataformas midiáticas como
jornais, estações de rádio, canais de televisão, etc.

\fala{M} Mas os petistas gostavam era da Globo. Pelo amor de Deus. Adoravam
...
\fala{G} No Brasil você lê um jornal ou assiste a um noticiário televisivo e é
...
\fala{M} Um País com tamanha desigualdade não pode ser democrático. Temos de
...
\fala{G} Mas agora o Lula fala em conquistar a casa-grande. O discurso dele e
do PT deu uma guinada para esquerda. Parece que o PT aprendeu a lição.

\fala{M} Discordo. O PT não aprendeu a lição. E não produziu grandes
...
\fala{G} Nos \emph{Cadernos do Cárcere}, Gramsci fala no impacto no povo por
...
\fala{M} Há vários. O Bosi, por exemplo. O almirante Othon, preso pela Lava
...
\fala{G} No entanto, eles não conseguem fazer esse trabalho de
conscientização.

\fala{M} Creio que conscientização é um verbo de outros tempos. Queremos que
os leitores falem com seus parentes, seus amigos, etc. E diga\fala{M} ``Olha
...
\fala{G} O Lula me falou em nossa entrevista que há um declínio da política. A
...
\fala{G} Qual é a diferença?

\fala{M} O povo é a nação, que teoricamente não existe. O povão são os
...
\fala{G} O Gilmar Mendes está te processando.

\fala{M} O Gilmar Mendes me processa na primeira instância. Se por acaso eu
...
\fala{G} Como explicar essa comparação entre a Lava Jato à operação italiana
\emph{Mani Pulite} (Mãos Limpas)?

\fala{M} O grande cara era o Borelli, chefe da força tarefa. O magistrado
...
\fala{G} Mas houve um peso pesado como o neosocialista Bettino Craxi que fugiu
...
\fala{M} Houve uma mudança brutal. Mas o Colombo disse aqui no Brasil que
...
\fala{G} O doleiro Funaro diz que ele pegou dinheiro do Cunha para oferecer
propinas no Congresso com o fim de apoiar o impeachment de Dilma. Essa
não foi uma delação importante?

\fala{M} Claro. Mas o Funaro foi preso faz pouco tempo e já se prestou a
...
\fala{M} O ódio em relação ao Lula existe em primeiro lugar devido a uma
...
\fala{G} Você falou em ódio de classes.

\fala{M} No Brasil o preconceito de classe é brutal. Temos Sowetos espalhados
...
\fala{G} Esse racismo envolve a classe social e a cor do outro.

\fala{M} Aqui existem duas formas de racismo gravíssimas e claríssimas. Uma é
...
\fala{G} Esse sadismo das elites, escreve Gilberto Freyre, remonta à crueldade
...
\fala{M} Acho perfeito. A esquerda brasileira execrou o Gilberto Freyre porque
...
\fala{G} Você prefere \emph{Sobrados e Mocambos}.

\fala{M} Acho ótimos os dois livros. Nós também temos os sobrados e mocambos,
os castelos e as favelas.

\fala{G} Concorda que as elites têm mais consciência de classe do que o povo?

\fala{M} O povo brasileiro não tem consciência de classe. Um pouco, talvez, em
...
\fala{G} Segundo Lula, a chave é o mercado interno para que o povo possa
consumir.

\fala{M} O Lula tem razão em acreditar no mercado interno. Esse povo
...
\fala{G} Com o golpe de 1937, Getúlio criou uma infraestrutura para o
...
\fala{M} A industrialização foi o caminho que ele buscou e era na época o
...
\fala{G} Lembro de uma entrevista que fiz com o Abílio Diniz em 2012 na qual
...
\fala{M} Os candidatos confiáveis a eles.

\fala{G} Descartar o Lula por um governo ilegítimo e apoiar um novo candidato
...
\fala{M} Trata-se de gente que não sabe reconhecer os méritos do Lula. O
...
\fala{G} Temos também o Scaff, da FIESP. Ele fala em estabilidade da economia
sob Temer.

\fala{M} Esse Scaff nem é empresário. Trata-se de uma figura terrível,
...
\fala{G} Segundo Lula, a direita está tentando criar um novo candidato, visto
que não há nenhum.

\fala{M} Essa tentativa existe. A questão é a seguinte. Os candidatos existem
...
\fala{G} É difícil compreender a ascensão da extrema-direita no Brasil. O
deputado Jair Bolsonaro promete maior segurança, quer armar o povo.

\fala{M} Te pergunto: Como explicar o movimento evangélico no Brasil?

\fala{G} O movimento pentecostal apoia o Bolsonaro.

\fala{M} Bolsonaro é um retrógrado. Primitivo. Se ele fosse presidente,
...
\fala{G} Essa mentalidade cultural explicaria a ascensão de Bolsonaro?

\fala{M} Falam no fascismo de Bolsonaro. Mas não é por aí. Bolsonaro
...
\fala{G} E os outros candidatos?

\fala{M} Não existem. O Doria não passa de um coitado. Um marqueteiro. Não dá
...
\fala{G} Esse reacionarismo de São Paulo remonta à chamada Revolução de 1932?

\fala{M} Remonta ao fato de que era a locomotiva, em primeiro lugar. A
...
\fala{G} Esse ódio ao imigrante por parte dos chamados ``quatrocentões'' não
pode ter sido projetado contra o nordestino, e no caso contra Lula?

\fala{M} Durou muito tempo esse ódio ao imigrante. Mas contra o Lula,
...
\fala{G} Do ponto de vista jornalístico, é importante entender como
...
\fala{M} Aqueles que acreditam ser de esquerda.

\fala{G} Há raros esquerdistas. Mas permanecem escudados pelos seus
...
\fala{M} Os jornais, de fato, têm tido muito êxito nessa campanha anti-Lula e
...
\fala{G} Entre as pessoas mais ricas do Brasil encontram-se os três Marinho,
...
\fala{M} Atacam o Temer por razões morais. Não é possível que o presidente
...
\fala{G} É estranho a mídia internacional, salvo raras exceções na Europa,
...
\fala{M} Em primeiro lugar o Brasil é muito distante. E não é fácil para o
...
\fala{G} \emph{Financial Times} e o \emph{Wall Street Journal}, por exemplo,
...
\fala{M} É a ditadura do capital. O neoliberalismo quer isso. É um desastre
...
\fala{G} Lula seria ainda o único a poder comandar o País em nível
internacional?

\fala{M} Quando governou o Brasil o Lula foi uma estrela internacional. Em
...
\fala{G} Trump não gostaria de uma vitória do Lula, mas o Obama e o
ex-presidente brasileiro se davam bem.

\fala{M} Se davam bem. Mas a postura muito independente de Lula a era difícil
...
\fala{G} O Celso Amorim me disse em entrevista recente que antes do Lula o
...
\fala{M} Depois de concluído com sucesso o pré-acordo, os Estados Unidos não
...
\fala{G} Por sua vez, o Fernando Henrique era submisso internacionalmente.
Adorava os norte-americanos.

\fala{M} Completamente. Clinton o abraçava toda hora.

\fala{G} A voltamos ao poder dos mercados, o que explicaria a submissão de
Fernando Henrique aos países ricos.

\fala{M} A privatização, quero dizer roubalheira sob Fernando Henrique, foi
...
\fala{G} Objetivo concretizado sob Temer.

\fala{M} É a grande vitória tardia de Fernando Henrique. É algo assustador. E
...
\fala{G} Causa estranheza o fato de os críticos de Lula sempre dizerem que
Fernando Henrique colocou ordem econômica no País.

\fala{M} Esses críticos pensam na estabilidade da moeda. Valendo-se de alguns
...
\fala{G} Agora a roubalheira é mais transparente. Vemos pessoas correndo com
malas repletas de dinheiro. E de todos os partidos.

\fala{M} É isso.

\fala{G} Você falou sobre os policiais federais que se comportam como jagunços
dos poderosos.
...
\fala{G} Um militar já se exprimiu em casa maçônica sobre uma possível
intervenção.

\fala{M} Não acredito em uma intervenção militar. E não sei como se
...
\fala{G} Por outro lado, os militares podem se voltar contra os poderosos.
Defendem a Petrobras, por exemplo.

\fala{M} São nacionalistas. Essa história do pré-sal certamente os irrita
...
\protect\hypertarget{_Hlk498086306}{}{}\fala{G} No golpe de 1964 houve tanques
para derrubar o João Goulart.

\fala{M} Em volta de Jango havia esquerdistas sinceros. As chamadas reformas
...
\fala{G} Washington viu a situação de outro ângulo.

\fala{M} Os Estados Unidos ofereceram suporte bélico, se precisassem. John
Kennedy, esse gênio da lâmpada, era um desastre. Kennedy é uma história
inventada.

\fala{G} No golpe de 1964 houve o apoio das elites que derrubaram um governo
...
\fala{M} O golpe de 2016 foi diferente e adequado ao contexto político no
...
\fala{G} Inclusive do ponto de vista jornalístico.

\fala{M} Claro. As coisas estavam entrelaçadas. O golpe e a ditadura que
...
\fala{G} Com o AI5, em 1968, você dirigia a \emph{Veja}. Ou seja, a censura
estava longe de ser uma brincadeira.

\fala{M} A \emph{Veja} era a maior revista de oposição. Não digeria a
...
\fala{G} Quando o teu entusiasmo pela abertura levou uma ducha fria?

\fala{M} Quando vi a chamada redemocratização percebi que tinha me enganado
redondamente.

\fala{G} A partir de 1985?

\fala{M} Quando Figueiredo sai pela porta dos fundos do Planalto, e caminhamos
para a eleição do Collor.

\fala{G} Com o apoio da Globo.

\fala{M} A Globo e a \emph{Veja}, entre outros, apoiaram o ``caçador de
...
\fala{G} Quando você começou a se interessar pelo Lula?

\fala{M} Comecei a ouvir falar do Lula porque preparava-se a greve de 1978. Um
...
\fala{G} Segundo o Lula, o Frei Chico não teve um impacto ideológico nele. O
que o irmão fez foi conseguir para ele um posto no sindicato.

\fala{M} É isso mesmo. Mas de volta ao dia em que conheci o Lula, o Bernardo e
...
\fala{G} Qual foi a reação à capa?

\fala{M} A reação dos leitores me pareceu muito boa porque a \emph{IstoÉ} foi
...
\fala{G} E quem foi o homem por trás do fim da censura.

\fala{M} O general Golbery do Couto e Silva. Ele tinha, de fato, o plano de
retorno à normalidade democrática, segundo o próprio.

\fala{G} Você me disse que o Golbery facilitou a formação de partidos
...
\fala{M} Eu nunca disse que o Golbery facilitou a formação do PT. Disse que o
...
\fala{G} Mas houve, de fato, uma verdadeira tentativa do Golbery de estilhaçar
as esquerdas como fez o Mitterrand com as direitas na França nos anos
1980.

\fala{M} No caso do Brasil não foi uma tentativa para estilhaçar as esquerdas.
...
\fala{G} E o Ulysses Guimarães queria as diretas.

\fala{M} E ganharia. Foi o senhor diretas. Mas não era um homem de esquerda.
...
\fala{G} Como se deu o teu contato com o Golbery?

\fala{M} Quem tinha contato com ele há algum tempo era o Elio Gaspari, quando
...
\fala{G} Mas nenhum deles tinha elos com a Sorbonne.

\fala{M} O primeiro foi o Castelo Branco, que tinha lido muito Victor Hugo e
...
\fala{G} À época o Golbery já tinha uma estratégia para devolver o governo aos
civis?

\fala{M} Estava tramando. Havia começado, pouco a pouco, e pretendia devolver
...
\fala{G} Por que vantagem?

\fala{M} Porque Orlando Geisel era uma espécie de condestável do poder
...
\fala{G} Em 1974, você nos levou, a Manuela e eu, a Brasília quando foi se
encontrar com o Golbery.

\fala{M} Exato. Estava presente fora da sala do Golbery o Roberto Civita. Ele
...
\fala{G} Lembro da cena. E como continua o plano de Golbery de entregar o
poder aos civis?

\fala{M} Em 1974 o Quércia se elegeu senador. O MDB colocou deputados e
...
\fala{G} Quando o Golbery disse para você se cuidar como jornalista após o
pronunciamento de Geisel em abril de 1975 ele sabia que pediriam a tua
cabeça... \fala{M} Claro. Para os Civita estava em jogo o empréstimo pedido a
...
\fala{G} Ele disse que você era o mais chato de todos os jornalistas.

\fala{M} Não, esse foi o Figueiredo. Me fez um grande elogio. Ele me confundiu
...
\fala{G} E com a \emph{IstoÉ} semanal veio tua amizade com o Lula.

\fala{M} Ficamos logo amigos. Amigos de jantar um na casa do outro.

\fala{G} Você me levou algumas vezes para comer frango com polenta na casa do
Lula.

\fala{M} Me lembro. E a Angélica (mulher de Mino) também ficou muito amiga da
...
\fala{G} E como foi a entrevista de 13 páginas com o Lula?

\fala{M} Nessa entrevista, o Lula me disse: ``Você sabe muito bem que não sou
...
\fala{G} Um homem que faz uma política doméstica voltada para o povo é
naturalmente de esquerda.

\fala{M} E com a independência do Brasil no cenário internacional. São as duas
...
\fala{G} Já disse ao Lula isso?

\fala{M} Sempre. Ele me lê, sabe. Ele diz que os trabalhadores brasileiros
...
\fala{G} Como estava o Lula no DOPS?

\fala{M} Tranquilo. Mas estava sendo muito bem tratado. O Tuma não somente
...
\fala{G} O Lula é uma força da natureza. Teve um câncer na garganta. Perdeu a
mulher. E está sendo condenado sem provas.

\fala{M} Sim, é um homem forte. Lidou com o câncer sem se lamentar. Perdeu a
...
\fala{G} O Mazzini, como já falamos, dizia que era fundamental repetir as
...
\fala{M} O Lula e a única pessoa, o único líder popular nacional capaz de
